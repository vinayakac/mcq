...
const MyExams = () => {
  const { joinCourses } = useOutletContext();
  ...
  const exams = [
    ...
    { id: 5, name: "Computer Exam 1", courseId: 3 }, // New exam for Computer
    { id: 6, name: "Computer Exam 2", courseId: 3 }, // New exam for Computer
    { id: 7, name: "PHP Exam 1", courseId: 4 }, // New exam for PHP
    { id: 8, name: "PHP Exam 2", courseId: 4 }, // New exam for PHP
    { id: 9, name: "Python Exam 1", courseId: 5 }, // New exam for Python
    { id: 10, name: "Python Exam 2", courseId: 5 }, // New exam for Python
                  ...
                  <td>
                    {courseExams.length > 0 ? (
                      courseExams.map((exam) => (
                        ...
                        >
                          <button className="take-exam-button">{`${exam.name}`}</button>
                        </Link>
                      ))
                    ) : (
